...
$boolean = static fn (mixed $value): bool => filter_var($value, FILTER_VALIDATE_BOOL);
...
return [
    ...
    */
    ...
    'enabled' => $boolean(env('PULSE_ENABLED', false)),
    ...
    */
    ...
    'recorders' => [
        Recorders\CacheInteractions::class => [
            'enabled' => $boolean(env('PULSE_CACHE_INTERACTIONS_ENABLED', false)),
        ...
        Recorders\Exceptions::class => [
            'enabled' => $boolean(env('PULSE_EXCEPTIONS_ENABLED', false)),
        ...
        Recorders\SlowOutgoingRequests::class => [
            'enabled' => $boolean(env('PULSE_SLOW_OUTGOING_REQUESTS_ENABLED', false)),
        ...
        Recorders\UserJobs::class => [
            'enabled' => $boolean(env('PULSE_USER_JOBS_ENABLED', false)),
        ...
        Recorders\UserRequests::class => [
            'enabled' => $boolean(env('PULSE_USER_REQUESTS_ENABLED', false)),
