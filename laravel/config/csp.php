...
$reportOnly = filter_var(env('CSP_REPORT_ONLY', true), FILTER_VALIDATE_BOOL);
$reportEndpoint = (string) env('CSP_REPORT_ENDPOINT', '');
...
return [
     ...
     */
    'presets' => $reportOnly ? [] : [ContentSecurityPolicy::class],
     ...
     */
    'report_only_presets' => $reportOnly ? [ContentSecurityPolicy::class] : [],
     ...
     */
    'report_only_uri' => $reportEndpoint,
     ...
     */
    'report_to' => $reportEndpoint === '' ? '' : 'csp-endpoint',
     ...
     */
    'report_only_to' => $reportEndpoint === '' ? '' : 'csp-endpoint',
     ...
     */
    'reporting_endpoints' => $reportEndpoint === '' ? [] : ['csp-endpoint' => $reportEndpoint],
