            ...
            <aside class="rounded-xl border border-slate-200 bg-white p-4 dark:border-slate-800 dark:bg-slate-900">
                <nav class="mb-5 flex flex-col gap-1 border-b border-slate-200 pb-5 text-sm dark:border-slate-800" aria-label="Primary">
                    ...
                    @can('manage-administration')
                        ...
                        <a class="rounded-lg px-3 py-2 font-medium hover:bg-slate-100 sm:hidden dark:hover:bg-slate-800" href="{{ route('admin.settings') }}">Settings</a><a class="rounded-lg px-3 py-2 font-medium hover:bg-slate-100 sm:hidden dark:hover:bg-slate-800" href="{{ route('admin.api-health') }}">API Health</a><a class="rounded-lg px-3 py-2 font-medium hover:bg-slate-100 sm:hidden dark:hover:bg-slate-800" href="{{ route('admin.config-check') }}">Config Check</a><a class="rounded-lg px-3 py-2 font-medium hover:bg-slate-100 sm:hidden dark:hover:bg-slate-800" href="{{ route('admin.webhook-health') }}">Webhook Health</a><a class="rounded-lg px-3 py-2 font-medium hover:bg-slate-100 sm:hidden dark:hover:bg-slate-800" href="{{ route('admin.slack-rules.edit') }}">Slack Rules</a><a class="rounded-lg px-3 py-2 font-medium hover:bg-slate-100 sm:hidden dark:hover:bg-slate-800" href="{{ route('admin.email-rules.edit') }}">Email Rules</a>
