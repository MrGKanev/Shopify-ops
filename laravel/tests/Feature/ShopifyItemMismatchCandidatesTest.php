...
class ShopifyItemMismatchCandidatesTest extends TestCase
{
    ...
    {
        Http::fake(['*' => Http::response(['data' => ['orders' => ['pageInfo' => ['hasNextPage' => false, 'endCursor' => null], 'edges' => [['node' => ['legacyResourceId' => '1', 'name' => '#1', 'createdAt' => '2026-06-01', 'displayFinancialStatus' => 'PENDING', 'lineItems' => ['nodes' => [['id' => 'gid://shopify/LineItem/1', 'sku' => 'A', 'quantity' => 2]]]]]]]]])]);
        ...
        Http::assertSent(fn (Request $request): bool => $request['variables']['search'] === 'status:any created_at:>=2026-06-01T00:00:00Z created_at:<=2026-06-30T23:59:59Z');
    }
}
