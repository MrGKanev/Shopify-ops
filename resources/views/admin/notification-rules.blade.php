            ...
            <div class="flex flex-col gap-5 rounded-xl border border-slate-200 bg-white p-6 dark:border-slate-800 dark:bg-slate-900">
                ...
                <form class="flex flex-col gap-5" method="POST" action="{{ route('admin.slack-rules.update') }}">
                    ...
                    <div class="grid gap-5 sm:grid-cols-2">
                        ...
                        <div>
                            <label class="text-sm font-medium" for="slack_audit_min_missing">Minimum missing orders</label>
                        ...
                        <div>
                            <label class="text-sm font-medium" for="slack_scan_min_rows">Minimum scan rows</label>
            ...
            <div class="flex flex-col gap-5 rounded-xl border border-slate-200 bg-white p-6 dark:border-slate-800 dark:bg-slate-900">
                ...
                <form class="flex flex-col gap-5" method="POST" action="{{ route('admin.discord-rules.update') }}">
                    ...
                    <div class="grid gap-5 sm:grid-cols-2">
                        ...
                        <div>
                            <label class="text-sm font-medium" for="discord_audit_min_missing">Minimum missing orders</label>
                        ...
                        <div>
                            <label class="text-sm font-medium" for="discord_scan_min_rows">Minimum scan rows</label>
