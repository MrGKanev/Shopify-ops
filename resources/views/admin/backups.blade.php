...
@section('content')
    <div class="flex flex-col gap-6">
        ...
        <x-data-table :headers="['File', 'Size', 'Created', 'Restore check', '']">
            ...
            @empty
                <tr><td class="px-4 py-8 text-center text-slate-500 dark:text-slate-400" colspan="5">{{ __('No backups found.') }}</td></tr>
            @endforelse
        </x-data-table>
    </div>
@endsection
