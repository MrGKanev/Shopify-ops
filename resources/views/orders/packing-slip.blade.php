...
<div class="flex flex-col gap-6">
    <section class="print-hidden"><p class="text-sm font-medium text-indigo-600 dark:text-indigo-400">Read-only workflow</p><h1 class="text-3xl font-bold">Packing slip preview</h1></section>
