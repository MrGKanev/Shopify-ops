...
return [
    ...
    'before_send' => [SentryEventSanitizer::class, 'sanitizeEvent'],

    'before_send_transaction' => [SentryEventSanitizer::class, 'sanitizeEvent'],

    'before_breadcrumb' => [SentryEventSanitizer::class, 'sanitizeBreadcrumb'],
